...
namespace GaleriaArte_mvc.Data
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Obra>()
                ...
                .UsingEntity<Dictionary<string, object>>(
                    "ExposicionObra",//nombre del modelo interno de entity framework 
                    ...
                    r => r.HasOne<Obra>()
                          ...
                          .OnDelete(DeleteBehavior.Restrict),
                    j => //Define la estructura de la tabla sql
                    {
            ...
            modelBuilder.Entity<Exposicion>().HasData(
                new Exposicion
                {
                    ...
                    FechaFin = Convert.ToDateTime("11/10/2025")
                }
                );
        }
    }
